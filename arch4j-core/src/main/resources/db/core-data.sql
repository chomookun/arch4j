...
values
    ('core.example.Example','Example','Example'),
    ('core.example.Example.exampleId','Example ID','Example ID'),
    ('core.example.Example.name','Example name','Name'),
    ('core.example.Example.icon','Example icon','Icon'),
    ('core.example.Example.number','Example number','Number'),
    ('core.example.Example.decimalNumber','Example bigDecimalNumber','DecimalNumber'),
    ('core.example.Example.dateTime','Example dateTime','DateTime'),
    ('core.example.Example.instantDateTime','Example instantDateTime','DateTime(UTC)'),
    ('core.example.Example.zonedDateTime','Example zonedDateTime','DateTime(Zone)'),
    ('core.example.Example.date','Example date','Date'),
    ('core.example.Example.time','Example time','Time'),
    ('core.example.Example.enabled','Example enabled','Enabled'),
    ('core.example.Example.type','Example type','Type'),
    ('core.example.Example.code','Example code','Code'),
    ('core.example.Example.text','Example text','Text'),
    ('core.example.Example.cryptoText','Example cryptoText','Text(Crypto)'),
    ('core.example.ExampleItem','Example item','Item'),
    ('core.example.ExampleItem.itemId','Example itemId','Item ID'),
    ('core.example.ExampleItem.name','ExampleItem name','Name'),
    ('core.example.ExampleItem.percentage','ExampleItem percentage','Percentage'),
    ('core.example.ExampleItem.dateTime','ExampleItem dateTime','DateTime'),
    ('core.example.ExampleItem.enabled','ExampleItem enabled','Enabled');

-- core_message_i18n
insert into `core_message_i18n`
    (`message_id`,`language`,`value`)
values
...
insert into `core_code`
    (`code_id`,`name`)
values
    ('core.example.Example.code','Code');
