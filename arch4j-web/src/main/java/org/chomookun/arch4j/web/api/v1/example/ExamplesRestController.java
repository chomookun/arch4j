...
@PreAuthorize("hasAuthority('api.example')")
@Tag(name = "examples", description = "Examples")
public class ExamplesRestController {
    ...
    /**
     * Creates example
     * @param exampleRequest example request
     * @return example response
     */
    @PostMapping
    @Transactional
    @PreAuthorize("hasAuthority('api.example.edit')")
    public ResponseEntity<ExampleResponse> createExample(
            @RequestBody @Validated ExampleRequest exampleRequest,
            @RequestHeader(value = "Prefer", required = false) String prefer
    ) {
        // example
    ...
    @Transactional
    @PreAuthorize("hasAuthority('api.example')")
    public ResponseEntity<ExampleResponse> modifyExample(
            @PathVariable("exampleId") String exampleId,
            @RequestBody @Validated ExampleRequest exampleRequest,
            @RequestHeader(value = "Prefer", required = false) String prefer
    ) {
